...
```{r, echo=F, fig.height=3, fig.width=10, fig.align='center', message=F, warning=F, fig.cap="Mapping two different variables from an external data frame"}
...
```{r, echo=F, fig.height=2, fig.width=10, fig.align='center', message=F, warning=F}
...
```{r, echo=F, fig.height=3, fig.width=10, fig.align='center', message=F, warning=F}
...
```{r, echo=T,fig.height=1, fig.width=10, fig.align='center', message=F, warning=F}
...
```{r, echo=F, fig.height=3, fig.width=10, fig.align='center', message=F, warning=F, fig.cap="The same data, represented using three different color schemes"}
grid.newpage() # Starting a new page
...
```{r, echo=F, fig.height=3, fig.width=10, fig.align='center', message=F, warning=F, fig.cap="Two different binning methods"}
...
```{r, echo=F, fig.height=3, fig.width=10, fig.align='center', message=F, warning=F, fig.cap="Using two different numeric values (20 and 50) to center the color scheme on a meaingful value"}
...
```{r,fig.height=3, fig.width=10, fig.align='center', message=F, warning=F}
...
```{r,fig.height=6, fig.width=6, fig.align='center', message=F, warning=F, fig.cap="A map with a histogram of the data distribution"}
...
```{r, echo=F, fig.height=3, fig.width=10, fig.align='center', message=F, warning=F, fig.cap="Three plots with standardized color schemes output from visualizing a time series. For the purposes of this illustration, these plots have been aligned horizontally, but would usually appear in separate plots."}
