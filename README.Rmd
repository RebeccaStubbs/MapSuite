...
```{r, echo=F, fig.align='center', fig.width=10, fig.height=4, message=F, warning=F}
library(imager)
...
```{r, echo=T, dpi=1000, fig.height=12, fig.width=10, fig.align='center', message=F, warning=F}
